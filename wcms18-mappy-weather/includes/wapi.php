...
function wapi_get_weather_for_position($lat, $lng){

	$result = wp_remote_get("http://api.openweathermap.org/data/2.5/weather?lat={$lat}&lon={$lng}&units=metric&appid=" . OWM_APP_ID);
