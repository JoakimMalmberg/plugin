...
class Social_Links_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			array( 'description' => __( 'Output social icons linked to profiles', 'sl_domain' ), ) // Args
		);
	}
	...
	public function update( $new_instance, $old_instance ) {
		...
		$instance = [
			//Links
			'facebook_link' => 
			(!empty($new_instance['facebook_link'])) ? 
			strip_tags($new_instance['facebook_link']) : 
			'',
			'twitter_link' => 
			(!empty($new_instance['twitter_link'])) ? 
			strip_tags($new_instance['twitter_link']) : 
			'',
			'linkedin_link' => 
			(!empty($new_instance['linkedin_link'])) ? 
			strip_tags($new_instance['linkedin_link']) : 
			'',
			'google_link' => 
			(!empty($new_instance['google_link'])) ? 
			strip_tags($new_instance['google_link']) : 
			'',

			//Icons
			'facebook_icon' => 
			(!empty($new_instance['facebook_icon'])) ? 
			strip_tags($new_instance['facebook_icon']) : 
			'',
			'twitter_icon' => 
			(!empty($new_instance['twitter_icon'])) ? 
			strip_tags($new_instance['twitter_icon']) : 
			'',
			'linkedin_icon' => 
			(!empty($new_instance['linkedin_icon'])) ? 
			strip_tags($new_instance['linkedin_icon']) : 
			'',
			'google_icon' => 
			(!empty($new_instance['google_icon'])) ? 
			strip_tags($new_instance['google_icon']) : 
			'',

			//Width
			'icon_width' => 
			(!empty($new_instance['icon_width'])) ? 
			strip_tags($new_instance['icon_width']) : 
			'',
		];
		return $instance;
	}
	...
	public function getForm( $instance ) {
		...
		?>
			...
			<p>
				...
				<input 
				type="widefat" 
				id="<?php echo $this->get_field_id('google_link'); ?>"
			...
			<p>
				...
				<input 
				type="widefat" 
				id="<?php echo $this->get_field_id('google_icon'); ?>"
			...
			<p>
				...
				<input 
				type="widefat" 
				id="<?php echo $this->get_field_id('icon_width'); ?>"
	 ...
	 *
	 * @param array $linkes Social Links
		...
		?>
			<div class="social-links">
				<a target="_blank" 
					...
					src="<?php echo esc_attr($icons['facebook']); ?>"
					>
				</a>
				<a target="_blank" 
					...
					<img 
					width="<?php echo esc_attr($icon_width); ?>" 
					src="<?php echo esc_attr($icons['twitter']); ?>"
					>
				</a>
				<a target="_blank" 
					...
					<img 
					width="<?php echo esc_attr($icon_width); ?>" 
					src="<?php echo esc_attr($icons['linkedin']); ?>"
					>
				</a>
				<a target="_blank" 
					href="<?php echo esc_attr($links['google']); ?>">
					<img 
					width="<?php echo esc_attr($icon_width); ?>" 
					src="<?php echo esc_attr($icons['google']); ?>"
					>
				</a>
			</div>
		<?php
