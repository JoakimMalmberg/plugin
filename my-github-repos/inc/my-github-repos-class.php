...
class WP_My_Github_Repos extends WP_Widget{
	...
	function __construct(){
		parent::__construct(
			...
			['description' => __('A Github repository widget', 'mgr_domain')],
		);
	}
	...
	public function form($instance){
		...
		if(isset($instance['title'])){
			...
			$title = __('Latest Github Repos', 'mrg_domain');
		}
		...
		if(isset($instance['username'])){
			...
			$username = __('joakimmalmberg', 'mrg_domain');
		}
