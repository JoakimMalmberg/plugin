...
function ffl_options_content(){
	...
	ob_start(); ?>
		<div class="wrap">
			<h2><?php echo _e('Facebook Footer Link Settings', 'ffl_domain'); ?></h2>
			<p><?php echo _e('Settings for the Facebook Footer Link plugin', 'ffl_domain'); ?></p>
			<form method="post" action="options.php">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<p class="description"><?php _e('Enter your color or HEX value with a #', 'ffl_domain'); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
				...
				<p class="submit">
					<input type="submit" name="submit" id="submit" class="button button-primary" value="<?php _e('Save Changes', 'ffl_domin'); ?>">
				</p>
			</form>
		</div>
	<?php
