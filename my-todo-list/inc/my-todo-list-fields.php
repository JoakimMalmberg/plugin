		...
		<div class="wrap todo-form">
			...
			<div class="form-group">
				...
				<input 
					...
					name="due_date" 
					id="due_date" 
					value="<?php if(!empty($mtl_todo_stored_meta['due_date'])) 
					echo esc_attr($mtl_todo_stored_meta['due_date'][0]) ?>"
				>
			</div>
...
function mtl_todos_save($post_id){
	...
	$is_valid_nonce = (isset($_POST['wp_todos_nonce']) 
	&& wp_verify_nonce($_POST['wp_todos_nonce'], basename(__FILE__))) ? 'true' : 'false';
